...
migrate-up:
	migrate -source file:./migrations/ -database postgres://macwin:1@localhost:5432/crud?sslmode=disable up

migrate-down:
	migrate -source file:./migrations/ -database postgres://macwin:1@localhost:5432/crud?sslmode=disable down